...
/**
* CorbaDropbox/_UserStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from CorbaDropbox.idl
* Tuesday, March 26, 2013 7:57:20 PM GMT
*/

public class _UserStub extends org.omg.CORBA.portable.ObjectImpl implements CorbaDropbox.User
{
  ...
  public boolean isLoggedIn ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_get_isLoggedIn", true);
                $in = _invoke ($out);
  ...
  public void isLoggedIn (boolean newIsLoggedIn)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_isLoggedIn", true);
                $out.write_boolean (newIsLoggedIn);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
