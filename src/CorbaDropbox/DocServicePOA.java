 ...
 implements CorbaDropbox.DocServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("listUserDocuments", new java.lang.Integer (4));
    _methods.put ("updateDoc", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // CorbaDropbox/DocService/uploadDoc
       {
         ...
         $result = this.uploadDoc (document);
         out = $rh.createReply();
       ...
       case 3:  // CorbaDropbox/DocService/listDocuments
       {
         ...
         out = $rh.createReply();
         CorbaDropbox.DocServicePackage.docListHelper.write (out, $result);
         break;
       }

       case 4:  // CorbaDropbox/DocService/listUserDocuments
       {
         CorbaDropbox.User user = CorbaDropbox.UserHelper.read (in);
         String $result[] = null;
         $result = this.listUserDocuments (user);
         out = $rh.createReply();
         CorbaDropbox.DocServicePackage.docListHelper.write (out, $result);
         break;
       }

       case 5:  // CorbaDropbox/DocService/updateDoc
       {
         CorbaDropbox.Document document = CorbaDropbox.DocumentHelper.read (in);
         boolean $result = false;
         $result = this.updateDoc (document);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
